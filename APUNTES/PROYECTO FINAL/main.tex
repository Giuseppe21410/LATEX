...
\documentclass{ifacconf} % El argumento del comando, define la estructura y  el formato general del documento, a partir del archivo de clase "ifacconf.cls".

\usepackage{graphicx}      % Requerido para incluir figuras.
\usepackage{natbib}        % Requerido para bibliografía.
%=============================================================================
\begin{document}
\begin{frontmatter}
...
% Con el comando "\title{...}", se presenta el título, no se aconseja que sea mayor a 10 palabras.



% Con el comando "\author{}" presentamos los autores del supuesto proyecto.
\author[First]{First A. Author} 
\author[Second]{Second B. Author, Jr.} 
\author[Third]{Third C. Author}

% Con el comando "\address[]{}" se clasifican entre corchetes las direcciones de cada autor. Visbles en el documento en forma de asterisco. Se referencian en la parte de autores "\author[First]{First A. Author}".
...
% El resumen es visible gracias al comando "\begin{abstract}". Se aconseja que no sea mayor a 250 palabras.
\begin{abstract} 
...
% Con el entorno "\begin{keyword}", se muestran las palabras más relevantes del documento, estos ayudan a posicionar el trabajo escrito en los buscadores cuando los subimos a internet. Van separadas por puntos y comas.
\begin{keyword}
